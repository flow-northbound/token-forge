...
export default function ColorsPage() {
  ...
  const [foregroundHSBA, setForegroundHSBA] = useState({ h: 0, s: 0, b: 0, a: 1 })
  const [backgroundHSBA, setBackgroundHSBA] = useState({ h: 0, s: 0, b: 100, a: 1 })
  ...
  const calculateContrastRatio = (fg: typeof foregroundHSBA, bg: typeof backgroundHSBA) => {
  ...
  const monochromaticScale = [
    { 
      ...
      h: 230, s: 100, b: 15, a: 0.90,
      contrast: "4.5:1"
    },
    { 
      name: "Text weak", 
      hsba: "hsba(230, 100%, 20%, 0.65)",
      h: 230, s: 100, b: 20, a: 0.65,
      contrast: "4.5:1"
    },
    { 
      name: "Stroke strong", 
      hsba: "hsba(230, 100%, 30%, 0.45)",
      h: 230, s: 100, b: 30, a: 0.45,
      contrast: "3:1"
    },
    { 
      name: "Stroke weak", 
      hsba: "hsba(230, 100%, 40%, 0.10)",
      h: 230, s: 100, b: 40, a: 0.10,
      contrast: "N/A"
    },
    { 
      name: "Fill weak", 
      hsba: "hsba(230, 100%, 50%, 0.04)",
      h: 230, s: 100, b: 50, a: 0.04,
      contrast: "N/A"
    },
    { 
      name: "Fill weaker", 
      hsba: "hsba(230, 100%, 50%, 0.02)",
      h: 230, s: 100, b: 50, a: 0.02,
      contrast: "N/A"
    }
  ]
  
  const statusColors = {
    error: { name: "Error", baseColor: errorColor, scale: generateColorScale(errorColor) },
    warning: { name: "Warning", baseColor: warningColor, scale: generateColorScale(warningColor) },
    success: { name: "Success", baseColor: successColor, scale: generateColorScale(successColor) }
  }
    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            System colors used to indicate different statuses in your application.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <div className="space-y-2">
              ...
              {statusColors.error.scale.map(({ name, color, hsba, contrast }) => (
          ...
          <div>
            ...
            <div className="space-y-2">
              <h4 className="text-sm font-medium">Color Scale</h4>
              {statusColors.warning.scale.map(({ name, color, hsba, contrast }) => (
                <div key={name} className="flex items-center gap-3">
                  <div 
                    className="h-8 w-16 rounded border"
                    style={{ backgroundColor: color }}
          ...
          <div>
            ...
            <div className="space-y-2">
              <h4 className="text-sm font-medium">Color Scale</h4>
              {statusColors.success.scale.map(({ name, color, hsba, contrast }) => (
                  <div key={name} className="flex items-center gap-3">
                    <div 
                      className="h-8 w-16 rounded border"
                      style={{ backgroundColor: color }}
      ...
      <div className="mt-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Check the contrast ratio between foreground and background colors in HSBA format.
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForegroundHSBA({ ...foregroundHSBA, h: Number(e.target.value) })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForegroundHSBA({ ...foregroundHSBA, s: Number(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              <div>
                <label className="block text-sm font-medium mb-2">Brightness (0-100)</label>
                <input
                  type="number"
                  min="0"
                  max="100"
                  value={foregroundHSBA.b}
                  onChange={(e) => setForegroundHSBA({ ...foregroundHSBA, b: Number(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              <div>
                <label className="block text-sm font-medium mb-2">Alpha (0-1)</label>
                <input
                  type="number"
                  min="0"
                  max="1"
                  ...
                  onChange={(e) => setForegroundHSBA({ ...foregroundHSBA, a: Number(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              <div className="mt-4">
                <div 
                  ...
                  style={{ 
                    backgroundColor: (() => {
                      const rgb = hsbToRGB(foregroundHSBA.h, foregroundHSBA.s, foregroundHSBA.b)
                      return `rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, ${foregroundHSBA.a})`
                    })()
                  }}
                />
                <p className="mt-2 text-sm font-mono text-muted-foreground">
                  hsba({foregroundHSBA.h}, {foregroundHSBA.s}%, {foregroundHSBA.b}%, {foregroundHSBA.a.toFixed(2)})
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBackgroundHSBA({ ...backgroundHSBA, h: Number(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBackgroundHSBA({ ...backgroundHSBA, s: Number(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBackgroundHSBA({ ...backgroundHSBA, b: Number(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBackgroundHSBA({ ...backgroundHSBA, a: Number(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              <div className="mt-4">
                <div 
                  ...
                  style={{ 
                    backgroundColor: (() => {
                      const rgb = hsbToRGB(backgroundHSBA.h, backgroundHSBA.s, backgroundHSBA.b)
                      return `rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, ${backgroundHSBA.a})`
                    })()
                  }}
                />
                <p className="mt-2 text-sm font-mono text-muted-foreground">
                  hsba({backgroundHSBA.h}, {backgroundHSBA.s}%, {backgroundHSBA.b}%, {backgroundHSBA.a.toFixed(2)})
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold">
                  {calculateContrastRatio(foregroundHSBA, backgroundHSBA).toFixed(2)}:1
                </span>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-sm font-medium ${calculateContrastRatio(foregroundHSBA, backgroundHSBA) >= 4.5 ? "text-green-600" : "text-red-600"}`}>
                    {calculateContrastRatio(foregroundHSBA, backgroundHSBA) >= 4.5 ? "✓ Pass" : "✗ Fail"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">WCAG AA Large Text (3:1)</span>
                  <span className={`text-sm font-medium ${calculateContrastRatio(foregroundHSBA, backgroundHSBA) >= 3 ? "text-green-600" : "text-red-600"}`}>
                    {calculateContrastRatio(foregroundHSBA, backgroundHSBA) >= 3 ? "✓ Pass" : "✗ Fail"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">WCAG AAA Normal Text (7:1)</span>
                  <span className={`text-sm font-medium ${calculateContrastRatio(foregroundHSBA, backgroundHSBA) >= 7 ? "text-green-600" : "text-red-600"}`}>
                    {calculateContrastRatio(foregroundHSBA, backgroundHSBA) >= 7 ? "✓ Pass" : "✗ Fail"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
